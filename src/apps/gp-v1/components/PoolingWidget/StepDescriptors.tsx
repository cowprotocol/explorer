...
import { StepDescriptionWrapper, ProgressStepText } from 'apps/gp-v1/components/PoolingWidget/PoolingWidget.styled'
import { ProgressBarProps } from 'apps/gp-v1/components/PoolingWidget/ProgressBar'
